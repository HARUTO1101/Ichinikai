...
const sampleOrders = [
  { id: '#1083', ticket: 'T-1248', total: 3200, status: '調理中', payment: '未払い', createdAt: '10:24' },
  { id: '#1082', ticket: 'T-1247', total: 1800, status: '受取可', payment: '支払い済み', createdAt: '10:20' },
  { id: '#1081', ticket: 'T-1246', total: 2400, status: '受注済み', payment: '未払い', createdAt: '10:18' },
]
...
const activities = [
  { id: 1, time: '10:25', message: 'T-1248 のステータスが「調理中」に更新されました。' },
  { id: 2, time: '10:18', message: '受付状態が「受け付け中」に変更されました。' },
  { id: 3, time: '10:12', message: '新規注文 T-1245 を受信しました。' },
  { id: 4, time: '09:58', message: 'T-1240 の支払いが完了しました。' },
]
          ...
          <div className="admin-toolbar">
            ...
            <div className="field">
              ...
              <select id="export-status" defaultValue="all">
                ...
                <option value="open">調理中まで</option>
                <option value="ready">受取可のみ</option>
